...
class PagePagination extends Component {
  ...
  renderPagination(array) {
    return array.map((index) => (
      <PaginationItem active={this.props.current_page==index+1 ? true:false } key={index+1}>
  ...
  render() {
    return (
      <Pagination style={{ cursor: 'pointer' }} className="pull-right">
        ...
        <PaginationItem disabled={this.props.current_page < this.props.end_page? false:true}>
